...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
		...
		<div class="product_Sort">
			<div class="title_name"><span class="floor">1F</span><span class="name">水果蔬菜</span>
				<span class="link_name"><a href="Product_Detail.html">苹果</a> | <a href="Product_Detail.html">香蕉</a> | <a
					...
					<a href="Product_Detail.html">青菜</a></span></div>
			<div class="Section_info clearfix">
				<div class="product_AD">
					<div class="pro_ad_slide">
						...
						<div class="bd">
							<ul>
								<li style="display: list-item;"><a href="Product_Detail.html"><img src="Content/images/ad-6.jpg"
											width="398" height="469"></a></li>
								<li style="display: none;"><a href="Product_Detail.html"><img src="Content/images/ad-7.jpg"
											width="398" height="469"></a></li>
							</ul>
						</div>
				...
				<div class="pro_list">
					<ul>
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_1.jpg" width="180px" height="160px"></a>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_2.jpg" width="180px" height="160px"></a>
							<a href="Product_Detail.html" class="p_title_name">Olay玉兰油 新生塑颜金纯活能水</a>
							<div class="Numeral"><span class="price"><i>￥</i>123.00</span><span
									class="Sales">销量<i>345</i>件</span>
							</div>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_3.jpg" width="180px" height="160px"></a>
							<a href="Product_Detail.html" class="p_title_name">Olay玉兰油 新生塑颜金纯活能水</a>
							<div class="Numeral"><span class="price"><i>￥</i>123.00</span><span
									class="Sales">销量<i>345</i>件</span>
							</div>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_4.jpg" width="180px" height="160px"></a>
							<a href="Product_Detail.html" class="p_title_name">Olay玉兰油 新生塑颜金纯活能水</a>
							<div class="Numeral"><span class="price"><i>￥</i>123.00</span><span
									class="Sales">销量<i>345</i>件</span>
							</div>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_25.jpg" width="180px" height="160px"></a>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_24.jpg" width="180px" height="160px"></a>
							<a href="Product_Detail.html" class="p_title_name">Olay玉兰油 新生塑颜金纯活能水</a>
							<div class="Numeral"><span class="price"><i>￥</i>123.00</span><span
									class="Sales">销量<i>345</i>件</span>
							</div>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_23.jpg" width="180px" height="160px"></a>
							<a href="Product_Detail.html" class="p_title_name">Olay玉兰油 新生塑颜金纯活能水</a>
							<div class="Numeral"><span class="price"><i>￥</i>123.00</span><span
									class="Sales">销量<i>345</i>件</span>
							</div>
						...
						<li>
							<a href="Product_Detail.html"><img src="Content/images/p_22.jpg" width="180px" height="160px"></a>
							<a href="Product_Detail.html" class="p_title_name">Olay玉兰油 新生塑颜金纯活能水</a>
							<div class="Numeral"><span class="price"><i>￥</i>123.00</span><span
									class="Sales">销量<i>345</i>件</span>
							</div>
	...
	<div class="slogen">
		<div class="index_style">
			<ul class="wrap">
				<li>
					<a href="Product_Detail.html"><img src="Content/images/slogen_34.png" data-bd-imgshare-binded="1"></a>
					<b>安全保证</b>
					<span>多重保障机制 认证商城</span>
				</li>
				<li><a href="Product_Detail.html"><img src="Content/images/slogen_28.png" data-bd-imgshare-binded="2"></a>
					<b>正品保证</b>
					<span>正品行货 放心选购</span>
				</li>
				<li>
					<a href="Product_Detail.html"><img src="Content/images/slogen_30.png" data-bd-imgshare-binded="3"></a>
					<b>七天无理由退换</b>
					<span>七天无理由保障消费权益</span>
				</li>
				<li>
					<a href="Product_Detail.html"><img src="Content/images/slogen_31.png" data-bd-imgshare-binded="4"></a>
					<b>天天低价</b>
